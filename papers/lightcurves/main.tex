...
associated light curve. Figure \ref{fig:transients} shows this process. 

\begin{figure*}
	\includegraphics[width=0.45\textwidth]{Transients.png}
  \caption{ATRANCCATA Dataset Set Up: Light curve compilation for transients.}
...
We end up with 16940 unique non-transient light curves. Figure \ref{fig:non-transients} shows this process. 

\begin{figure*}
	\includegraphics[width=0.45\textwidth]{NonTransients.png}
  \caption{ATRANCCATA Dataset Set Up: Light curve compilation for non-transients.}
